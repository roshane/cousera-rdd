...
class ListsSuite extends FunSuite {
  ...
  test("max of List(3, 7, 2, 100, 999, -45) is 999") {
    assert(max(List(3, 7, 2, 100, 999, -45)) === 999)
  }

  test("max of List(-3, -7, 2, -100, -999, -45, 0) is 0") {
    assert(max(List(-3, -7, -2, -100, -999, -45, 0)) === 0)
  }
}
